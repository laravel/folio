...
it('may have routes', function (string $name, array $scenario) {
    ...
    'podcasts.show-by-positional-id' => ['podcasts/[id].blade.php', [1], '/podcasts/1'],
    ...
    'podcasts.show-by-positional-slug-and-id' => ['podcasts/[slug]/[id].blade.php', ['nuno', 1], '/podcasts/nuno/1'],
    'podcasts.show-by-named-slug-and-positional-id' => ['podcasts/[slug]/[id].blade.php', ['slug' => 'nuno', 1], '/podcasts/nuno/1'],
    'podcasts.show-by-null-named-slug-and-positional-values' => ['podcasts/[slug]/[id].blade.php', ['slug' => null, 'nuno', 1], '/podcasts/nuno/1'],
    'podcasts.show-by-model' => ['podcasts/[Podcast].blade.php', ['podcast' => fn () => Podcast::first()], '/podcasts/1'],
    'podcasts.show-by-positional-model' => ['podcasts/[Podcast].blade.php', [fn () => Podcast::first()], '/podcasts/1'],
    'podcasts.show-by-model-fqn' => ['podcasts/[.Tests.Feature.Fixtures.Podcast].blade.php', ['podcast' => fn () => Podcast::first()], '/podcasts/1'],
    'podcasts.show-by-positional-model-fqn' => ['podcasts/[.Tests.Feature.Fixtures.Podcast].blade.php', [fn () => Podcast::first()], '/podcasts/1'],
    'podcasts.show-by-model-name-1' => ['podcasts/[Podcast:name].blade.php', ['podcast' => fn () => Podcast::first()], '/podcasts/test-podcast-name-1'],
    'podcasts.show-by-positional-model-name-1' => ['podcasts/[Podcast:name].blade.php', [fn () => Podcast::first()], '/podcasts/test-podcast-name-1'],
    'podcasts.show-by-model-name-2' => ['podcasts/[Podcast-name].blade.php', ['podcast' => fn () => Podcast::first()], '/podcasts/test-podcast-name-1'],
    'podcasts.show-by-positional-model-name-2' => ['podcasts/[Podcast-name].blade.php', [fn () => Podcast::first()], '/podcasts/test-podcast-name-1'],
    'podcasts.show-by-backed-enum' => ['podcasts/[Category].blade.php', ['category' => Category::Post], '/podcasts/posts'],
    'podcasts.show-by-positional-backed-enum' => ['podcasts/[Category].blade.php', [Category::Post], '/podcasts/posts'],
    ...
    'podcasts.many-by-positional-id' => ['podcasts/[...id].blade.php', [[1, 2, 3]], '/podcasts/1/2/3'],
    ...
    'podcasts.many-by-positional-model' => ['podcasts/[...Podcast].blade.php', [fn () => Podcast::all()], '/podcasts/1/2'],
    ...
    'podcasts.many-by-positional-backed-enum' => ['podcasts/[...Category].blade.php', [[Category::Post, Category::Video]], '/podcasts/posts/video'],
    'podcasts.many-by-positional-slug-and-id' => ['podcasts/[...slug]/[...id].blade.php', [['nuno', 'taylor'], [1, 2]], '/podcasts/nuno/taylor/1/2'],
    'podcasts.show-by-non-contiguous-positional-keys' => ['podcasts/[slug]/[id].blade.php', [2 => 'nuno', 5 => 1], '/podcasts/nuno/1'],
    ...
    'podcasts.positional-id-with-query-parameter' => ['podcasts/[id].blade.php', [1, 'details'], '/podcasts/1?details'],
...
it('may have absolute routes', function (string $name, array $scenario) {
    ...
    'podcasts.show-by-positional-account-and-name' => ['podcasts/[name].blade.php', '{account}.domain.com', ['taylor', 'Taylor'], 'http://taylor.domain.com/podcasts/Taylor'],
    'podcasts.show-by-named-account-and-positional-name' => ['podcasts/[name].blade.php', '{account}.domain.com', ['account' => 'taylor', 'Taylor'], 'http://taylor.domain.com/podcasts/Taylor'],
    'podcasts.show-by-positional-account-and-named-name' => ['podcasts/[name].blade.php', '{account}.domain.com', ['taylor', 'name' => 'Taylor'], 'http://taylor.domain.com/podcasts/Taylor'],
    'podcasts.show-by-domain-path-and-query-position' => ['podcasts/[name].blade.php', '{account}.domain.com', ['taylor', 'Taylor', 'details'], 'http://taylor.domain.com/podcasts/Taylor?details'],
...
test('missing parameters', function (string $name, array $scenario) {
    ...
    'podcasts.show-with-too-few-positional-parameters' => ['podcasts/[slug]/[id].blade.php', 'domain.com', ['nuno'], 'Missing required parameter [id] for path [resources/views/pages/podcasts/[slug]/[id]].'],
    'podcasts.show-with-null-positional-parameter' => ['podcasts/[id].blade.php', 'domain.com', [null], 'Missing required parameter [id] for path [resources/views/pages/podcasts/[id]].'],
